...
train_generator = datagen.flow_from_directory(
    './Ship/Train/',  # Replace with your training data directory
    target_size=(224, 224),
    color_mode='rgb',
...
val_generator = datagen.flow_from_directory(
    './Ship/Validate/',  # Replace with your validation data directory
    target_size=(224, 224),
    color_mode='rgb',
    batch_size=batch_size,
    class_mode='categorical',
...
testPath = './Ship/Test/'  # Replace with your test data directory
